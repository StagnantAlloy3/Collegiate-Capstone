...
function ManualItemSearchNavigation({props}: {props: any}) {
  ...
  return (
    <manualTabs.Navigator>
      <manualTabs.Screen
        name="Manual Search"
        children={() => <ManualItemSearch props={props} />}
      />
      <manualTabs.Screen
        name="Item Details"
        children={() => <ItemDetails props={props} />}
      />
    </manualTabs.Navigator>
  );
}
  ...
  return (
    <NavigationContainer>
      ...
      <Tab.Navigator
        ...
        activeColor={theme.colors.navBarIcon}
        ...
        <Tab.Screen
          name="Search"
          children={() => <ManualItemSearchNavigation props={theme} />}
          options={{
            tabBarLabel: 'Search',
            tabBarIcon: () => (
              <MaterialIcons
        ...
        <Tab.Screen
          name="Details2"
          children={() => <DetailsScreen props={theme} />}
          options={{
